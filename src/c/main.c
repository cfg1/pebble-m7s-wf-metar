...
static void set_Date_Layer_size(void){
  ...
  if (DisplaySeconds){
    if (TimeZoneFormat == 2){
      ...
      layer_set_frame(text_layer_get_layer(Date_Layer), GRect(50+X_OFFSET, 132+Y_OFFSET, 64+22, 20));
      text_layer_set_text_alignment(Date_Layer, GTextAlignmentLeft);
    } else if (TimeZoneFormat == 1){
...
static void main_window_load(Window *window) {
  ...
  // Date text
  Date_Layer = text_layer_create(GRect(72+X_OFFSET, 132+Y_OFFSET, 64 /* width */, 20 /* height */)); 
  ...
  cwLayer = text_layer_create(GRect(2+X_OFFSET, 70+Y_OFFSET, 144-4, 17));
  ...
  weather_layer_7_string_1 = text_layer_create(GRect(87+X_OFFSET, 54-15+Y_OFFSET, 144-86-2-1, 30)); //TODO
  ...
  weather_layer_7_string_2 = text_layer_create(GRect(2+X_OFFSET, 50+Y_OFFSET, 82, 17)); //TODO
