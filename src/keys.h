...
#define KEY_LOCATION_NAME       0 //unused
#define KEY_LOCATION_LAT        1
#define KEY_LOCATION_LON        2
#define KEY_WEATHER_TEMP        3 //used for colors (°C is transmitted)
...
#define KEY_WEATHER_STRING_1    8 //not used any more //in this string, all infos for the text under the temp. will be collected. (including \n)
#define KEY_WEATHER_STRING_2    9 //not used any more //in this string, all infos for the text under the moon and battery will be collected.
#define KEY_TIME_UTC_OFFSET    10 //Time offset to UTC in seconds
#define KEY_TIME_LAST_UPDATE   11 //Time of last phone update
#define KEY_TIME_ZONE_NAME     12 //Time Zone Name from Phone, e.g. CEST, CET, PBL, ...
...
#define KEY_SET_DEGREE_F       25 //not used any more
